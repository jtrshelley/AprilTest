...
- (void)viewDidLoad
{
    ...
    for(int i = 0; i < elevations.count; i++){
        ...
        if( temp.count < 3) break;
            ...
            float elevation_value = [[temp objectAtIndex:2] floatValue];
            ux.backgroundColor = [UIColor colorWithHue:0.0 saturation: 0.0 brightness: 1 - elevation_value/705 alpha:0.25];
        [ux setHidden:TRUE];
        [blocks addObject:ux];
